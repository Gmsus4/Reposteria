...
export const CTA = () => {
  return (
    <div className="about-cta flex flex-col xs:flex-row gap-3 pt-2">
      <Link href={socialMedia[0].href} className="btn rounded-primarySize bg-primaryColor text-yellow shadow-none border-none hover:scale-105 transition-transform duration-200 px-7">
