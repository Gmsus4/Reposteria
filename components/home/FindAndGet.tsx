...
export const FindAndGet = () => {
  return (
    <div className="bg-secundaryColor w-full xs:min-h-[calc(100dvh-4rem)] md:py-26 py-16 flex flex-col items-center justify-center md:gap-16 gap-12 px-6">
      ...
      <div className="max-w-7xl w-full grid grid-cols-1 xs:grid-cols-3 gap-8 sm:gap-10 lg:gap-16">
