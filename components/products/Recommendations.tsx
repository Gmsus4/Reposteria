...
export const Recommendations = () => {
    return (
        <>
            <h2 id="recomendaciones" className="text-center md:text-7xl text-5xl font-caveat text-primaryColor mb-10 scroll-mt-20">Recomendaciones generales <br />para tus postres</h2>
            <div className="relative max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="grid place-items-center gap-2 rounded-primaryColor p-10 border-primaryColor/30 bg-primaryColor/5 border-1">
                    <IconTemperatureSun className="text-primaryColor mb-2" height={30} width={30}/>
                    <h3 className="text-primaryColor font-bold font-caveat mb-2 text-3xl text-center">Evita el sol directo</h3>
                ...
                <div className="grid place-items-center gap-2 rounded-primaryColor p-10 border-primaryColor/30 bg-primaryColor/5 border-1">
                    ...
                    <h3 className="text-primaryColor font-bold font-caveat mb-2 text-3xl text-center">Refrigera, no congeles</h3>
                ...
                <div className="grid place-items-center gap-2 rounded-primaryColor p-10 border-primaryColor/30 bg-primaryColor/5 border-1">
                    ...
                    <h3 className="text-primaryColor font-bold font-caveat mb-2 text-3xl text-center">Prepáralo antes del evento</h3>
                    <p className="text-primaryColor text-center">Para tu evento sacar del refrigerador el producto de 20 a 30 minutos antes </p>
                </div>
                <div className="rounded-primaryColor overflow-hidden md:col-span-3 col-span-1">
