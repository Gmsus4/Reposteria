...
export const AboutDetails = () => {
  return (
    <div className="bg-cream xs:min-h-[calc(100dvh-4rem)] md:py-26 py-16 flex flex-col items-center justify-center md:gap-16 gap-12 px-6">
      <div className="relative max-w-7xl">
        <div className="min-h-[600px] grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div className="grid gap-4">
            <div className="grid lg:gap-0 gap-4">
              <h2 className="text-darkWarm font-titleText text-3xl md:text-6xl leading-tight">Nuestra Forma <br /> de Trabajar</h2>
              <p className="text-base text-darkWarm/70 leading-relaxed">
            ...
            <div className="icons grid grid-cols-1 xs:grid-cols-2 place-items-center pt-4 gap-0 self-start">
              {features.map(({ icon: Icon, label, border }) => (
                ...
                >
                  <div className="bg-primary rounded-primarySize w-12 h-12 grid place-items-center">
                    <Icon className="text-darkWarm" />
                  </div>
                  <p className="text-base text-darkWarm text-center">{label}</p>
                </div>
              ))}
            </div>
          </div>
